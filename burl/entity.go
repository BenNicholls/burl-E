...
//Basic entity definition. Entities position and visual information. Anything that occupies
...
func NewBurlEntity(x, y int, v Visuals) *BurlEntity {
	return &BurlEntity{x, y, v, EntityLight{}}
}
